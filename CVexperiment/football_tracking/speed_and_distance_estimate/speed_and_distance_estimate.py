...
class SpeedAndDistance_Estimate:
    def __init__(self):
        self.frame_window = 5
        self.frame_rate = 24
    def add_seppd_and_distance_to_tracks(self,tracks):
        ...
        for object,object_tracks in tracks.items():
            ...
            for frame_num in range(0,number_of_frames,self.frame_window):
                ...
                for track_id,_ in object_tracks[frame_num].items():
                    ...
                    seppd_meters_per_second=distance_covered/time_elapsed
                    seppd_km_per_hour=seppd_meters_per_second*3.6
                    ...
                    for frame_num_batch in range(frame_num,last_frame):
                        if track_id not in tracks[object][frame_num_batch]:
                            continue
                        tracks[object][frame_num_batch][track_id]['speed']=seppd_km_per_hour
