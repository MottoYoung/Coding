            ...
            for frame_num,track in enumerate(object_tracks):
                if object=="players" or object=="referees":
                    for track_id,track_info in track.items():
                        ...
                        camra_movement=camera_movement_per_frame[frame_num]
                        position_adjusted=(position[0]-camra_movement[0],position[1]-camra_movement[1])

                        tracks[object][frame_num][track_id]['position_adjusted']=position_adjusted
                if object=="ball" and track.get("position")!=None:
